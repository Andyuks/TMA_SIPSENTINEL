...
class VoIPAnomalyDetector:
    ...
    def calculate_certainty(self, predictions):
...
def main():
    ...
    if choice == 0:
        ...
        certainty = detector.calculate_certainty(predictions)
        print(f"\nAnalysis complete. With {certainty:.2f}% certainty, there was an attack in the analyzed traffic.")
        ...
        data = detector.extract_features_live(interface, duration)
        predictions = detector.predict(data)
        
        certainty = detector.calculate_certainty(predictions)
        print(f"\nLive Traffic Analysis complete. With {certainty:.2f}% certainty, there was an attack in the analyzed traffic.")
