...
def extract_pcap_features(pcap_file):
    ...
    data = []
    sip_invites = 0  # Contador de SIP INVITE para detección de SIP flooding
    ...
    for packet in cap:
        ...
        if sip_invites > 10:  # Si hay más de 10 SIP INVITES en un intervalo de 1 segundo
            features["Etiqueta"] = 'ataque_SIP'
        elif rtp_packets > 100:  # Si hay más de 100 paquetes RTP en un intervalo de 1 segundo
